...
# 更新 serverURL
sed -i "s|serverURL:.*|serverURL: https://\$RAILWAY_DOMAIN/|g" _config.anzhiyu.yml

echo "✅ 配置已更新，请检查 _config.anzhiyu.yml 中的 serverURL"
`;

fs.writeFileSync(path.join(__dirname, 'update-config.sh'), updateConfigScript);

console.log('\n📝 已创建配置更新脚本: tools/waline/update-config.sh');
