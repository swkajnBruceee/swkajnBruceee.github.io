...
## Hexo AnZhiYu 主题配置 Waline

有了 Waline 服务地址后，我们需要在 Hexo 的 AnZhiYu 主题中配置 Waline 评论系统：
...
## Hexo AnZhiYu 主题配置 Giscus

在 AnZhiYu 主题的配置文件中添加 Giscus 配置：
...
// 配置文件路径
const configPath = path.join(__dirname, '_config.anzhiyu.yml');
