const anzhiyu = {
  ...
  switchCommentBarrage: function () {
    ...
    let commentBarrageText = document.querySelector(".menu-commentBarrage-text");
    let commentBarrageButton = document.querySelector("#consoleCommentBarrage, #menu-commentBarrage");
    if (commentBarrage && commentBarrageText && commentBarrageButton) {
      if (window.getComputedStyle(commentBarrage).display === "flex") {
        commentBarrage.style.display = "none";
        anzhiyu.snackbarShow("✨ 已关闭评论弹幕");
        commentBarrageText.textContent = "显示热评";
        commentBarrageButton.classList.remove("on");
        localStorage.setItem("commentBarrageSwitch", "false");
      } else {
        commentBarrage.style.display = "flex";
        commentBarrageText.textContent = "关闭热评";
        commentBarrageButton.classList.add("on");
